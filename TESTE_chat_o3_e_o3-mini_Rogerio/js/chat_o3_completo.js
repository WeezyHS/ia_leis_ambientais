// /teste-static/js/chat_o3_completo.js
document.addEventListener('DOMContentLoaded', () => {
    ...
    const startNewChat = () => {
      ...
      conversations.set(tempKey, {
        id: null,
        title: 'Novo chat',
        messages: [{ role: 'assistant', content: 'Olá! Como posso ajudar você hoje? (Teste modelo o3)' }]
      });
    ...
    const handleSendMessage = async (event) => {
      ...
      try {
        // Envia pro backend - MODIFICADO PARA USAR /ask-ia-o3
        const body = {
